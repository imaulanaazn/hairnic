...
if(isset($_POST['subscribe'])){
    $redirect = "Location: index.php#newsletter";
...
<body>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 text-center text-lg-start">
                    ...
                    <p class="text-white mb-4 animated slideInRight">Experience a healthier hair care routine with our organic shampoo, enriched with natural extracts that gently cleanse, restore vitality, and protect your hair without the use of harmful chemicals..</p>
                    <a href="products.php" class="btn btn-dark py-2 px-4 me-3 animated slideInRight">Shop Now</a>
                    <a href="contact.php" class="btn btn-outline-dark py-2 px-4 animated slideInRight">Contact Us</a>
                </div>
                <div class="col-lg-6">
                    <img class="img-fluid animated pulse infinite" src="assets/img/shampoo.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="assets/img/shampoo-1.png">
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="text-primary mb-4">Healthy Hair <span class="fw-light text-dark">Is A Symbol Of Our
                            Beauty</span></h1>
                    <p class="mb-4">Nourish your hair with the goodness of organic ingredients, giving it the strength, shine, and vitality that reflect your true natural beauty.</p>
                    <p class="mb-4">Our organic shampoo is crafted to protect, repair, and revitalize your hair—because beauty begins with healthy roots and radiant strands.</p>
                    <a class="btn btn-primary py-2 px-4" href="products.php">Shop Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid deal bg-primary my-5 py-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="assets/img/shampoo-2.png">
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    <div class="bg-white text-center p-4">
                        <div class="border p-4">
                            ...
                            <h1 class="display-4 text-primary mb-4"><?= formatIDR($todayDeal['price']) ?></h1>
                            <h5><?= $todayDeal['name'] ?></h5>
                            <p class="mb-4"><?= $todayDeal['description'] ?>.</p>
        ...
        <div class="container">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="text-primary mb-3"><span class="fw-light text-dark">Best Benefits Of Our</span> Natural Hair
                    Shampoo</h1>
                <p class="mb-5">Discover the secret to beautiful hair with our organic formula that gently cleanses, deeply nourishes, and enhances your natural glow.</p>
            </div>
            <div class="row g-4 align-items-center">
                ...
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <img class="img-fluid animated pulse infinite" src="assets/img/shampoo.png">
                </div>
                <div class="col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="row g-5">
                        <div class="col-12 d-flex">
                    ...
                    <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.1s">
                        <?php foreach($feedbacks as $feedback) :?>
                            <div class="testimonial-item text-center" data-dot="1">
                                <img class="img-fluid border p-2" src="assets/img/<?= $feedback['photo']?>" alt="">
                                <h5 class="fw-light lh-base text-white"><?= $feedback['message'] ?></h5>
                                <h5 class="mb-1"><?= $feedback['name'] ?></h5>
                                <h6 class="fw-light text-white fst-italic mb-0"><?= $feedback['profession'] ?></h6>
                            </div>
                        <?php endforeach ?>
                    </div>
                </div>
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    <div class="blog-item border h-100 p-4">
                        <img class="img-fluid mb-4" src="assets/img/blog-1.jpg" alt="">
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    <div class="blog-item border h-100 p-4">
                        <img class="img-fluid mb-4" src="assets/img/blog-2.jpg" alt="">
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.5s">
                    <div class="blog-item border h-100 p-4">
                        <img class="img-fluid mb-4" src="assets/img/blog-3.jpg" alt="">
    ...
    <!-- Newsletter Start -->
    <div class="container-fluid newsletter bg-primary py-5 my-5" id="newsletter">
        <div class="container py-5">
            <div class="mx-auto text-center wow fadeIn" data-wow-delay="0.1s" style="max-width: 600px;">
                ...
                <div class="col-md-7 wow fadeIn" data-wow-delay="0.5s">
                    <div class="position-relative w-100 mt-3 mb-2">
                        <form action="index.php" method="POST">
                            <input name="subscribe" class="form-control w-100 py-4 ps-4 pe-5" type="text" placeholder="Enter Your Email"
                                style="height: 48px;">
